...
function createUserEmbed(message, type, item, includedData) {
	...
	.addField("Favorite Genre", (userData.animeGenre.length ? userData.animeGenre : "N/A") + " (" + userData.animeGenreCount.toString() + ")", true)
	.addField("Ratings Given", userData.contentRated, true)
	.addField("Manga Finished", userData.mangaFinished.length ? userData.mangaFinished : "0", true)
	.addField("Favorite Genre", (userData.mangaGenre.length ? userData.mangaGenre : "N/A") + " (" + userData.mangaGenreCount.toString() + ")", true)
